...
class Product extends CI_Controller {
	...
	public function __construct(){
		Parent::__construct();
		$this->load->model('Common_model','pm');
	}
	
	public function index()
	{
		$data['products']=$this->pm->retriveResult('products');
	...
	public function create(){
		...
		if($this->form_validation->run()===FALSE){
			...
			if($this->pm->insert('products',$this->input->post()))
	...
	public function edit($id){
		...
		if($this->form_validation->run()===FALSE){
			$con['id']=$id;
			$data['product']=$this->pm->retriveRow('products','*',$con);
			...
			$con['id']=$id;
			if($this->pm->update('products',$this->input->post(),$con))
				$this->session->set_flashdata('msg','Data has been saved.');
			else
				$this->session->set_flashdata('msg','Data has not been saved. Please try again');
	...
	public function delete($id){
		$data['id']=$id;
		if($this->pm->delete('products',$data))
			echo "data deleted";
		else
