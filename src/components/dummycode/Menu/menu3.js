...
const Menu = ({ showHeader = true, showFooter = true, }) => {
    ...
    // const handleCouponClick = (menuItem) => {
    //     if (!couponApplied) {
    ...
    const handleCouponClick = (menuItem) => {
        if (menuItem.coupon_code && menuItem.discount_percentage) {
            // Check if the coupon has already been applied to this item
            if (!couponApplied[menuItem.id]) {
                // Apply the coupon discount
                const discount = (menuItem.price * menuItem.discount_percentage) / 100;
                // Add this item to the cart with the discount
                addItem(menuItem, menuItem.quantity, { discount });
                // Update couponApplied state to mark this item as having the coupon applied
                setCouponApplied({ ...couponApplied, [menuItem.id]: true });
            }
        }
    };
                                                                        ...
                                                                        <div>
                                                                            {couponApplied ? (
                                                                                ...
                                                                                <button
                                                                                    ...
                                                                                    id='couponBtn'
                                                                                    onClick={() => handleCouponClick(menuItem)}
                                                                                >
                                                                                    Apply Coupon
                                                                                </button>
                                                                            )}
