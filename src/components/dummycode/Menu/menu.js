...
const Menu = ({ showHeader = true, showFooter = true, }) => {
    ...
    const handleCouponClick = (menuItem, category) => {
        // Apply the coupon logic here and update the menu item price
        const updatedMenuItems = category === 'Breakfast' ? [...Breakfast] : category === 'Lunch' ? [...Lunch] : [...Dinner];
        const updatedMenuItem = updatedMenuItems.find((item) => item.id === menuItem.id);

        if (updatedMenuItem) {
            updatedMenuItem.price = applyCoupon(menuItem);
            if (category === 'Breakfast') {
                setBreakfast(updatedMenuItems);
            } else if (category === 'Lunch') {
                setLunch(updatedMenuItems);
            } else {
                setDinner(updatedMenuItems);
            }
        }
    };
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="w-100 d-flex flex-column text-start ps-4">
                                                            <h5 className="d-flex justify-content-between border-bottom pb-2">
                                                                ...
                                                                <span className="text-primary">${applyCoupon(menuItem)}</span>
                                                            </h5>
